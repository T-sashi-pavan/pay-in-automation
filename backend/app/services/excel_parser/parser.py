...
STATES_LIST = [
    ...
    "cg", "ct", "dadra", "dn", "daman", "diu", "dd", "delhi", "ncr", "dl", "goa", "ga", "gujarat",
    "gj", "haryana", "hr", "himachal", "hp", "himachal pradesh", "jammu", "kashmir", "jk", "jharkhand",
    "jh", "karnataka", "ka", "kerala", "kl", "ladakh", "la", "lakshadweep", "ld", "madhya pradesh",
    "mp", "maharashtra", "mh", "manipur", "mn", "meghalaya", "ml", "mizoram", "mz", "nagaland", "nl",
    "odisha", "od", "orissa", "or", "puducherry", "pondicherry", "py", "punjab", "pb", "rajasthan",
        ...
        for r_idx, row in df_sliced.iterrows():
                ...
                if is_pivot:
                    ...
                    for loc in locations:
                        ...
                        # If the cell contains tiered-rate text (any age-tier pattern detected),
                        # ALWAYS emit a SLAB rule — even if all tiers share the same rate_pct.
                        # Falling through to the else branch would produce a NON_SLAB rule with
                        # an empty percentage (normalize_percentage can't parse the full tiered
                        # text string), which is exactly the "empty % in Non-Slab" bug reported.
                        if age_tiers is not None:
